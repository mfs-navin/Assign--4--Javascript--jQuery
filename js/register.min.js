...
$('#password').keyup(function(){
  ...
  {
    input.removeClass('valid').addClass('invalid');
    input.next().removeClass('error').addClass('error_show').text("Should be greater than 6 Characters");
  }
  ...
  {
    input.removeClass('valid').addClass('invalid');
    input.next().removeClass('error').addClass('error_show').text("Should be less than 18 Characters");
  }
...
if( state_value == "")
{
  ...
  state.next().removeClass("error").addClass("error_show");
}

else
{
  state.removeClass("invalid").addClass("valid");
  state.next().removeClass("error_show").addClass("error");
}
